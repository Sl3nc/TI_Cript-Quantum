...
from .profiler_cpu import start_cpu_profile, stop_cpu_profile
from .profiler_memory import trace_memory
from .system_stats import SystemSampler
...
class ProfilerManager:
    ...
    def stop_profiling(self) -> Dict[str, Any]:
        ...
        """
        cpu_metrics = stop_cpu_profile(self.cpu_profiler) if self.cpu_profiler else {}
    ...
    def profile_function(self, func: Callable, *args, **kwargs) -> Dict[str, Any]:
        ...
        memory_result = trace_memory(func, *args, **kwargs)
