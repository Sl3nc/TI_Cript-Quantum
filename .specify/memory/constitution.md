...
- Armazenamento de resultados: diretório dedicado (`docs/results/` ou equivalente) com tabelas + metadados de ambiente.
...
9. Commit incluindo resultados e referências de versão.  
...
- Processo de Emenda: (1) Propor mudança com justificativa; (2) Atualizar Constituição + Relatório de Impacto; (3) Ajustar templates dependentes; (4) Bump de versão conforme regra; (5) Commit com mensagem padronizada. 
...
- Commit Message Padrão: `docs: amend constitution to vX.Y.Z (<summary>)`.
